...
% [mu,X,ncvg,iter,varargout]=LanFRO(OpC,Mfun,v,tol,checkcvg,nev,maxit)
...
%  * tol (class numeric) - tolerance value.
%  * checkcvg (function_handle) - checkcvg(mu,res,tol) returns a mask 
