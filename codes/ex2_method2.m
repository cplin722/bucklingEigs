%
% Script file: ex2_method2.m
%
% This is a demo script for example2. Assuming that the common nullspace 
% basis ZC of K and KG is orthonormal, the matrix-vector product u=Cv is 
% computed by first computing a solution u_p of the consistent singular 
% linear system
%     (K - sig*KG)u_p = K*v.
